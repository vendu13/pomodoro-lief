...
const Task = (props) => {
    ...
    const {setTaskData, setUpdateTask, currentTask, setCurrentTask, deleteTask} = useContext(Context)
    ...
    return (
        ...
        >
            ...
            <Button primary style={{backgroundColor: '#FFCA58', borderColor: '#FFCA58', position: "absolute", right: '1rem'}} onClick={handleUpdate} label="Update" />
            <Button
                primary
                style={{backgroundColor: '#FFCA58', borderColor: '#FFCA58', position: "absolute", right: '1rem', top: 70}}
                onClick={handlePick}
            ...
            <Button
                primary
                    style={{backgroundColor: '#FFCA58', borderColor: '#FFCA58', position: "absolute", right: '1rem', top: 115}}
