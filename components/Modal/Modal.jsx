...
const Modal = ({showModal, setShowModal, text}) => {
    ...
    const {taskData, addNewTask, updateTask, setUpdateTask, updateTaskData} = useContext(Context)
                    ...
                    <Box pad="xlarge" style={{width: '40rem'}}>
                        ...
                        <Form>
                            ...
                            <FormField name="description" label="Description">
                                <TextInput name="description" value={description}
                                           onChange={(e) => setDescription(e.target.value)}/>
                            </FormField>
                            <FormField name="dueDate" label="Due Date">
                                <TextInput type="date" name="dueDate" value={dueDate}
                                           onChange={(e) => setDueDate(e.target.value)}/>
                            </FormField>
                            <FormField name="tomatoes" label="Tomatoes spent">
                                <TextInput name="tomatoes" type="number" value={tomatoes}
